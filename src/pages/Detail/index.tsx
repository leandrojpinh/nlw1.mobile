...
//implementar o component de select dos estados do IBGE
//react-native-picker-select
//<RNPickerSelect onValueChange={(value) => console.log(value)} items={[ { label: 'hahha', value: 'hahaha']} />
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        <TouchableOpacity onPress={handleNavigateBack}>
          <Icon name='arrow-left' size={20} color='#32cb79' />
        </TouchableOpacity>
